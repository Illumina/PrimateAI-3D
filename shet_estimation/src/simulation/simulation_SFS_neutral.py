...
'''
The forward time population simulation assumes neutral evolution. 
...
seqlen=100000  ###Simulate 100,000 independent loci
...
if __name__ == '__main__':
    ...
    samplesize=246000
    f = open(outdir+'afs_simul_synony_'+snptype+'_'+str(T1)+'_'+str(Nefactor)+'_'+str(popratio)+'.txt', "w")
